...
$.alertinf = function (config) {
	...
	container = $('<div>', { id: 'alertinf' });
	content = $('<div>', { id: 'alertinfContent' });
	close = $('<a>', { 'class': 'close', href: 'javascript:;', html: '&times' });
	actions = $('<div>', { id: 'alertinfActions' });
	overlay = $('<div>', { id: 'overlay' });
	title = $('<h2>', { text: options.title });
...
//	cancel = $('<button>', { 'class': 'btn btn-small btn-quaternary', text: options.cancelText });
	...
	if (options.overlayClose) {
		overlay.bind ('click', function (e) { $.alertinf.close (); });
	}
	
	if (options.escClose) {
		$(document).bind ('keyup.alertinf', function (e) {
			var key = e.which || e.keyCode;
...
$.alertinf.close = function () {
	$('#alertinf').remove ();
	$('#overlay').remove ();
	$(document).unbind ('keyup.alertinf');
}
...
$(function () {
	...
	$('.widget-tabs').each (function () {
		...
		if (content.length > 1) {
			...
			$('#tab-1').html('<center><img src="images/loaders/squares.gif"/></center>');
			tabscallback('#tab-1');
		}
	});
...
function tabClick (e) {
	...
	$(id).show ();
	$(id).html('<center><img src="images/loaders/squares.gif"/></center>');
	tabscallback(id);
}
